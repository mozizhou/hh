  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column
        ...
        sortable>
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.days" placeholder="请输入项目名称" maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
            {{ scope.row.days }}
          </div>
        </template>
      ...
      <el-table-column
        ...
        sortable>
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.projectName" placeholder="请输入项目名称"
                    maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
      ...
      <el-table-column
        ...
        sortable>
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.name" placeholder="请输入项目名称" maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
            {{ scope.row.name }}
          </div>
        </template>
      ...
      <el-table-column
        ...
        label="单位">
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.unit" placeholder="请输入项目名称" maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
            {{ scope.row.unit }}
          </div>
        </template>
      ...
      <el-table-column
        ...
        label="总数量">
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.total" placeholder="请输入项目名称" maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
            {{ scope.row.total }}
          </div>
        </template>
      ...
      <el-table-column
        ...
        label="总金额">
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.totalAmount" placeholder="请输入项目名称"
                    maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
      ...
      <el-table-column
        ...
        label="领料人">
        <template slot-scope="scope">
          <el-input v-if="scope.row.isEdit" v-model="scope.row.picker" placeholder="请输入项目名称" maxlength="50"/>
          <div v-else-if="!scope.row.isEdit">
            {{ scope.row.picker }}
          </div>
        </template>
