        ...
        <pane size="84">
          <el-col>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="公司" align="center" key="company" prop="company" v-if="columns[7].visible"/>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="公司" prop="company">
              <el-input v-model="form.company" placeholder="请输入公司名称" maxlength="30"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
